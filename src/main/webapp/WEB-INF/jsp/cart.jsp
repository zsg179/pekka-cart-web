...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://localhost:8082"><img clstag="clickcart|keycount|xincart|logo" src="/images/pekka-logo.jpg"  width="150" height="62" alt="皮卡" title="返回皮卡商城首页" alt="返回皮卡商城首页"></a></div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去皮卡国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去皮卡结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
